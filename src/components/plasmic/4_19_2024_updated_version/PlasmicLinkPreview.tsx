...
import * as sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: WT_1bmzB1Q9M/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__wbNou)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__itz9R)}>
              <div className={classNames(projectcss.all, sty.freeBox__p8TUh)}>
                <h5
