...
import * as sty from "./PlasmicDialog.module.css"; // plasmic-import: xB4twfLZXITa/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__gBkzx)}
              >
                <div
                  className={classNames(
                    projectcss.all,
