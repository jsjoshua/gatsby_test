...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: FYb5fbIPeIpK/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: hsihclVHXvJ_/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__swejw)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mx7Qq)}
              />
            </React.Fragment>
          ),
          value: args.children
