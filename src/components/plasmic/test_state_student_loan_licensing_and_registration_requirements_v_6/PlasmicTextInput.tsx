...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: WjYg1GJgqoVX/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: gnIX0uTuWhAa/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__m8Jo)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__r5F3)}
              role={"img"}
            />
          ),
