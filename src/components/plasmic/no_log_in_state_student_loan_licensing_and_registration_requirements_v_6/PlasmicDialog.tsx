...
import * as sty from "./PlasmicDialog.module.css"; // plasmic-import: tsLSDU38SnxU/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_TNIZW-iRnM1L"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___3LSoj)}
              >
                <div
                  className={classNames(
                    projectcss.all,
