...
import Button from "../../Button"; // plasmic-import: ZRavXFH79zyt/component
...
import * as sty from "./PlasmicNavBar.module.css"; // plasmic-import: 5Y4i3sXA1sYl/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: KIj1WUkVTcpS/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ItecZlVQ9XPj/icon
...
export type PlasmicNavBar__ArgsType = {
  loginSuccess5?: boolean;
  onLoginSuccess5Change?: (val: string) => void;
  firstName?: string;
    ...
    () => [
      {
        ...
        valueProp: "loginSuccess5",
        onChangeProp: "onLoginSuccess5Change"
      },
      {
    ...
    <NavigationBar
      ...
      brand={
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__gVe8M)}
            displayHeight={"40px"}
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__cnXw3)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
      ...
      menuItems={
        <React.Fragment>
          {(() => {
            ...
            <Button
              className={classNames("__wab_instance", sty.button__ta2F)}
              color={"link"}
              onClick={async event => {
                const $steps = {};
          ...
          <Button
            className={classNames("__wab_instance", sty.button__nAitt)}
            color={"clear"}
          ...
          <Popover
            ...
            overlay={
              <div className={classNames(projectcss.all, sty.freeBox__pgWcT)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
          ...
          >
            <Button2
              className={classNames("__wab_instance", sty.button___3Bksa)}
              color={"clear"}
              size={"compact"}
            >
              <div
          ...
          <Popover
            ...
            overlay={
              <div className={classNames(projectcss.all, sty.freeBox___3Xp9)}>
                {(() => {
                  try {
                    return $state.loginSuccess5;
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button___6BJa)}
                    color={"clear"}
                    onClick={async event => {
                      const $steps = {};
                        ...
                        items: (
                          <React.Fragment>
                            <AntdAccordionItem
                              className={classNames(
                                "__wab_instance",
                                sty.accordionItem__ugHdA
                              )}
                              headerClass={classNames({
                                [sty["pcls_-Oaa2BbGceQR"]]: true
                              })}
                              id={1}
                              label2={
                                <div
                            ...
                            <AntdAccordionItem
                              className={classNames(
                                "__wab_instance",
                                sty.accordionItem__pGrAo
                              )}
                              headerClass={classNames({
                                [sty["pcls_dHpU7qggxon8"]]: true
                              })}
                              id={2}
                              label2={
                                <div
          ...
          >
            <Button2
              className={classNames("__wab_instance", sty.button__dpJ8C)}
              color={"clear"}
              size={"compact"}
              submitsForm={false}
            >
              ...
              >
                <React.Fragment>
                  {(() => {
                    try {
                      return $state.loginSuccess5 == true
                        ? "Log Out"
                        : "Log In";
                    } catch (e) {
                      if (
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__hgjPa)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
