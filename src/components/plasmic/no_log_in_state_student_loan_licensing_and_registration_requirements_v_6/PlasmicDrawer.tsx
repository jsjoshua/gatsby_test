...
import * as sty from "./PlasmicDrawer.module.css"; // plasmic-import: VXmouE0rJlFC/css
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_tg6qatBRE0Uq"]]: true })}
          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                >
                  <AntdInput
                    className={classNames("__wab_instance", sty.input__kaVo1)}
                  />
                </FormItemWrapper>
                <FormItemWrapper
                  className={classNames(
                    "__wab_instance",
                    sty.formField___36WVb
                  )}
                  label={"Last Name"}
                ...
                >
                  <AntdInput
                    className={classNames("__wab_instance", sty.input___2RNwu)}
                  />
                </FormItemWrapper>
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__nu7Yu)}
                  label={"Email"}
                  name={"commentemail"}
                  rules={[{ ruleType: "required" }]}
                >
                  <AntdInput
                    className={classNames("__wab_instance", sty.input___8S2S9)}
                  />
                </FormItemWrapper>
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__tG6Tz)}
                  label={"Message"}
                  name={"message"}
                  rules={[{ ruleType: "required" }]}
                >
