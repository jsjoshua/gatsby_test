...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: olj1LAj9FRAU/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ZngaSqsgmJK6/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__jeNqp)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__kc0Yu)}
              />
            </React.Fragment>
          ),
          value: args.children
