...
import * as sty from "./PlasmicDialog.module.css"; // plasmic-import: 2EtTDdUkYqrf/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_WpUu7Gr_Zfig"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___8XNwl)}
              >
                <div
                  className={classNames(
                    projectcss.all,
