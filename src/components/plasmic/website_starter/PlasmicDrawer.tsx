...
import Button from "../../Button"; // plasmic-import: MSPfcKpbOJcM/component
...
import * as sty from "./PlasmicDrawer.module.css"; // plasmic-import: xM4vvb6jzZ0F/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__s8QBa)}
              >
                <div
                  className={classNames(
                    projectcss.all,
