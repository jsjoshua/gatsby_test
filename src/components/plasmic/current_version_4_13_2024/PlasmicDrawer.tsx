...
import * as sty from "./PlasmicDrawer.module.css"; // plasmic-import: LRb8mJ2YevSE/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__pdJq)}
              >
                <div
                  className={classNames(
                    projectcss.all,
