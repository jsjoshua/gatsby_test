...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: pVEjU0YPCv4u/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: ypqo68r6o8jX/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: sbz0yO9tMcLU/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: 3mapajLEzu8-/icon
