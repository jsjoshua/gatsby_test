...
import * as sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: 3xNyZIKKA07z/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__oaVu8)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__hI9XT)}>
              <div className={classNames(projectcss.all, sty.freeBox__zV5SC)}>
                <h5
