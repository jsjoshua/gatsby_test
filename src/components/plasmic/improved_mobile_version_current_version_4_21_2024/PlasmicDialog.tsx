...
import * as sty from "./PlasmicDialog.module.css"; // plasmic-import: Lz7e6uUHXkyl/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__h5E0)}
              >
                <div
                  className={classNames(
                    projectcss.all,
